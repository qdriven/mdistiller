...
# CTDKD(Curriculum Temperature for DKD) CFG
CFG.CTDKD = CN()
CFG.CTDKD.CE_WEIGHT = 1.0
CFG.CTDKD.ALPHA = 1.0
CFG.CTDKD.BETA = 8.0
CFG.CTDKD.T = 4.0
CFG.CTDKD.WARMUP = 20
CFG.CTDKD.INIT_TEMPERATURE = 4.0
...
CFG.GRLCTDKD.MIN_TEMPERATURE = 1.0   # Minimum temperature value
CFG.GRLCTDKD.MAX_TEMPERATURE = 10.0  # Maximum temperature value
